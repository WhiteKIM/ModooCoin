...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ModooCoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a ModooCoin: URI or payment request"));
