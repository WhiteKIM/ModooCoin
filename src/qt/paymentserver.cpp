...
const QString BITCOIN_IPC_PREFIX("ModooCoin:");
#ifdef ENABLE_BIP70
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/ModooCoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ModooCoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ModooCoin-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start ModooCoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("ModooCoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'ModooCoin://' is not a valid URI. Use 'ModooCoin:' instead."),
