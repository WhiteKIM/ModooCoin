...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.ModooCoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.ModooCointools.com");
        vSeeds.emplace_back("dnsseed.ModooCoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.ModooCointools.com");
        vSeeds.emplace_back("seed-b.ModooCoin.loshan.co.uk");
