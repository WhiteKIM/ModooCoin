...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ModooCoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ModooCoin-tx [options] <hex-tx> [commands]  Update hex-encoded ModooCoin transaction\n" +
            "or:     ModooCoin-tx [options] -create [commands]   Create hex-encoded ModooCoin transaction\n" +
            "\n";
